...
;
;	Loadable AmigaOS hunk-format module for the Luett/8 font.
;
;	> vasmm68k_mot -Fhunkexe -kick1hunks -nosym -o FONTS:Luett/8 luett8.asm
;
	IDNT LUETT8
...
LUETT_MERGE	SET	1
	...
	ENDC
		...
		dc.l	_LuettName  ; dfh_DF+ln_Name
